...
/// réelle pour l'instant (pas d'API branchée) — "Enregistrer" appelle
/// [onSave] tel quel, sans vérifier le contenu des champs.
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Column(
                  children: [
                    AvatarWithBadge(size: 90, badgeIcon: Icons.camera_alt_outlined, onBadgeTap: widget.onChangePhoto),
